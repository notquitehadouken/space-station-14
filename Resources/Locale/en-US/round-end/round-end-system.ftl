...
round-end-system-shuttle-no-callers-autocall-announcement = Long-distance scans indicate that nothing capable of calling the emergency shuttle remains on-station, so one has been sent. ETA: {$time} {$units}.
